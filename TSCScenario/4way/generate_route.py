...
@LastEditTime: 2023-11-25 18:19:39
'''
...
# 开启仿真 --> 指定 net 文件
sumo_net = current_file_path("./env/4way.net.xml")
...
generate_route(
    ...
    edge_turndef={
        'E0__E1': [0.5, 0.5, 0.8, 0.5, 0.8, 0.5],
        '-E1__-E0': [0.5, 0.5, 0.8, 0.5, 0.8, 0.5],
        'E2__E3': [0.8, 0.8, 0.5, 0.8, 0.5, 0.8],
        '-E3__-E2': [0.8, 0.8, 0.5, 0.8, 0.5, 0.8],
    },
    veh_type={
